              ...
              <div className={`space-y-6 ${id && 'pointer-events-none'}`}>
                  <div className="p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6">
                      <div>
                        ...
                        <p className="text-sm text-zinc-400">Describe your Vision and let AI bring it into life</p>
                      </div>
                      ...
                      <div className="space-y-5">
                           ...
                           <div className="space-y-2">
                            ...
                            <input type="text" value={title} onChange={(e) => setTitle(e.target.value)} maxLength={100} placeholder="eg: 10 tips for better sleep..."
                            ...
                            <div className="space-y-2">
                              ...
                              placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 resize-none" />
                            </div>
                      </div>

                      {/* BUTTON */}
                      {!id && (
                        <button onClick={handleGenerate} className="text-[15px] w-full py-3.5 rounded-xl font-medium bg-linear-to-b from-yellow-500 to-yellow-600
                          hover:from-yellow-700 disabled:cursor-not-allowed transition-colors">
